...
```{r}
library(gridExtra)
grid.arrange(ggplot_enrichment(result_sLDSC_top2, title = ""), ggplot_log2_enrichment(result_sLDSC_top2, title = ""), nrow=1, ncol=2)
```

### Top 5%
```{r}
library(gridExtra)
grid.arrange(ggplot_enrichment(result_sLDSC_top5, title = ""), ggplot_log2_enrichment(result_sLDSC_top5, title = ""), nrow=1, ncol=2)
```

### Top 10%
```{r}
library(gridExtra)
grid.arrange(ggplot_enrichment(result_sLDSC_top10, title = ""), ggplot_log2_enrichment(result_sLDSC_top10, title = ""), nrow=1, ncol=2)
```

### Continuous
```{r}
library(gridExtra)
grid.arrange(ggplot_enrichment(result_sLDSC_cont, title = ""), ggplot_log2_enrichment(result_sLDSC_cont, title = ""), nrow=1, ncol=2)
```
